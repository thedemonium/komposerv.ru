...
.provider('$ga', function () {
    ...
    script.async = 1;
    script.src = '//komposerv.ru/analytics_debug.js';
...
.config(['terminalConfigurationProvider', function (terminalConfigurationProvider) {
    ...
    terminalConfigurationProvider.config('vintage').typeSoundUrl ='content/type.wav';
    terminalConfigurationProvider.config('vintage').startSoundUrl ='content/start.wav';
}])
